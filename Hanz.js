...
const { virtex } = require('./media/virtex/virtex')
...
const { virtag } = require('./media/virtex/virtag')
...
┃┃✯ Sc Bot : https://youtube.com/HANZ々OFC彡
┗━━━━━━━`
gam = fs.readFileSync('./media/thumnail.jpg')
but = [
...
sendButton(from, "GOPAY : 083144394823 (Mikey)", faketeks, but, mek)
break
case 'dana':
if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
but = [
...
sendButton(from, "DANA : 083144394823 (Mustakim)", faketeks, but, mek)
break
case 'ovo':
if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
but = [
...
sendButton(from, "OVO : 083144394823 (Mustakim)", faketeks, but, mek)
break
case "runtime":
case "test":
if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
